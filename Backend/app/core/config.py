...
# ── Document Ingestion — Thread Pool ──────────────────────────────────────────

INGEST_POOL_MIN_WORKERS = int(os.getenv("INGEST_POOL_MIN_WORKERS", 8))
...
# ── Document Ingestion — OCR Pre-filter ───────────────────────────────────────

OCR_MIN_VARIANCE      = int(os.getenv("OCR_MIN_VARIANCE", 300))
OCR_MAX_ASPECT        = float(os.getenv("OCR_MAX_ASPECT", 8.0))
OCR_MIN_UNIQUE_COLORS = int(os.getenv("OCR_MIN_UNIQUE_COLORS", 10))

# ── Document Ingestion — OCR Processing ───────────────────────────────────────

OCR_UPSCALE_FACTOR = int(os.getenv("OCR_UPSCALE_FACTOR", 2))
OCR_PSM_MODE       = int(os.getenv("OCR_PSM_MODE", 11))

# ── Document Ingestion — Image-Dominant Page ──────────────────────────────────

IMAGE_DOMINANT_MIN_IMAGES     = int(os.getenv("IMAGE_DOMINANT_MIN_IMAGES", 2))
IMAGE_DOMINANT_MAX_TEXT_CHARS = int(os.getenv("IMAGE_DOMINANT_MAX_TEXT_CHARS", 400))
...
# ── Table Extraction — Mid-word / Concatenation Thresholds ────────────────────

TABLE_MID_WORD_AVG_LEN_MIN       = int(os.getenv("TABLE_MID_WORD_AVG_LEN_MIN", 30))
TABLE_MID_WORD_NUMERIC_RATIO_MAX = float(os.getenv("TABLE_MID_WORD_NUMERIC_RATIO_MAX", 0.25))
TABLE_CONCAT_WORDS_RATIO_MAX     = float(os.getenv("TABLE_CONCAT_WORDS_RATIO_MAX", 0.30))
TABLE_NUMERIC_RATIO_FLOOR        = float(os.getenv("TABLE_NUMERIC_RATIO_FLOOR", 0.30))
...
VECTOR_TOP_K             = 5
EMBED_WORKERS            = int(os.getenv("EMBED_WORKERS", 5))
EMBED_POOL_CONNECTIONS   = int(os.getenv("EMBED_POOL_CONNECTIONS", 15))

# ── LLM Generation Settings ────────────────────────────────────────────────────

MODEL_MAX_TOKENS     = int(os.getenv("MODEL_MAX_TOKENS", 900))
EXECUTIVE_MAX_TOKENS = int(os.getenv("EXECUTIVE_MAX_TOKENS", 1500))
SECTION_MAX_TOKENS   = int(os.getenv("SECTION_MAX_TOKENS", 900))
...
MIN_ENTITY_NAME_LENGTH  = int(os.getenv("MIN_ENTITY_NAME_LENGTH", 2))
EXTRACTOR_MAX_WORKERS   = int(os.getenv("EXTRACTOR_MAX_WORKERS", 2))
EXTRACTOR_ASYNC_WORKERS = int(os.getenv("EXTRACTOR_ASYNC_WORKERS", 8))
CHUNK_TIMEOUT_SECONDS   = int(os.getenv("CHUNK_TIMEOUT_SECONDS", 30))
RETRY_TIMEOUT_SECONDS   = int(os.getenv("RETRY_TIMEOUT_SECONDS", 15))
...
FACT_VERIFIER_WORKERS            = int(os.getenv("FACT_VERIFIER_WORKERS", 5))
...
GRAPH_REL_ASYNC_WORKERS         = int(os.getenv("GRAPH_REL_ASYNC_WORKERS", 8))
...
GRAPH_MAX_ENTITIES_PER_LLM_CALL = int(os.getenv("GRAPH_MAX_ENTITIES_PER_LLM_CALL", 12))
